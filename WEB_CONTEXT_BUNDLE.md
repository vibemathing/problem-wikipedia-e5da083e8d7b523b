...
```json
{
  ...
  "problem_contract": {
    ...
    "aliases": [
      "wikipedia:wikipedia-e5da083e8d7b523b"
    ],
    "allowed_axioms": [
    ...
    "problem_id": "problem:wikipedia-e5da083e8d7b523b",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "wikipedia-e5da083e8d7b523b",
        "url": "https://en.wikipedia.org/wiki/Imbalance_conjecture"
      }
    ],
    "statement": {
      "language": "en",
      "text": "The imbalance conjecture : If the imbalance for each edge of a graph is at least 1, is the multiset of all edge imbalances always graphic ?",
      "version": 1
    },
    "title": "imbalance conjecture",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "7970c495496f844fe37f4745c340710bb89160c54e4bf7f2dfc6089d3de4013a"
}
```
